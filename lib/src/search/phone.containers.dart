...
extension SearchPhoneContainerExtension on SearchPhone {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, SearchPhone.toPointer);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(core.List<SearchPhone?>? obj) {
    ...
    return vector.toNativeVector(obj, SearchPhone.toPointer);
  }
  ...
  static string_map.StringMap<SearchPhone> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr, (val) => SearchPhone.fromPointer(val, needFree: false));
  }
...
extension SearchPhoneTypeContainerExtension on SearchPhoneType {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, SearchPhoneType.toPointer);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
    ...
    return vector.toNativeVector(obj, SearchPhoneType.toPointer);
  }
  ...
  static string_map.StringMap<SearchPhoneType> toPlatformMap(
      ffi.Pointer<ffi.Void> ptr) {
    return string_map.StringMap(
        ptr, (val) => SearchPhoneType.fromPointer(val, needFree: false));
  }
