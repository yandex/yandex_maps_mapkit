...
extension SearchPanoramaContainerExtension on SearchPanorama {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, SearchPanorama.toPointer);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(core.List<SearchPanorama?>? obj) {
    ...
    return vector.toNativeVector(obj, SearchPanorama.toPointer);
  }
  ...
  static string_map.StringMap<SearchPanorama> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr, (val) => SearchPanorama.fromPointer(val, needFree: false));
  }
...
extension SearchPanoramasObjectMetadataContainerExtension
  ...
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, SearchPanoramasObjectMetadata.toPointer);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
    ...
    return vector.toNativeVector(obj, SearchPanoramasObjectMetadata.toPointer);
  }
  ...
  static string_map.StringMap<SearchPanoramasObjectMetadata> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr,
        (val) =>
            SearchPanoramasObjectMetadata.fromPointer(val, needFree: false));
  }
