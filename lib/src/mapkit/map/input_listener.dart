...
import 'package:yandex_maps_mapkit/src/mapkit/map/map.dart' as mapkit_map_map;

/// @nodoc
class _MapInputListenerWrapper implements ffi.Finalizable {
...
final ffi.Pointer<ffi.Void> Function(
        ...
        ffi.Pointer<
            ffi
            .NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, mapkit_geometry_point.PointNative)>>)
    _MapInputListener_new = lib.library
        .lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, mapkit_geometry_point.PointNative)>>, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>, mapkit_geometry_point.PointNative)>>)>>(
            'yandex_flutter_mapkit_map_MapInputListener_new')
        .asFunction(isLeaf: true);
...
void _MapInputListener_onMapTap(ffi.Pointer<ffi.Void> _ptr,
  ...
  final listener = MapInputListener._pointerToListener[_ptr]?.target;
  if (listener == null) {
    throw core.Exception();
  }
  try {
    listener.onMapTap(mapkit_map_map.Map.fromNativePtr(map),
...
void _MapInputListener_onMapLongTap(ffi.Pointer<ffi.Void> _ptr,
  ...
  try {
    listener.onMapLongTap(mapkit_map_map.Map.fromNativePtr(map),
        mapkit_geometry_point.Point.fromNative(point));
  } catch (e, stack) {
    exception.nativeAssert(
        'Unhandled exception $e from native call listener\n$stack');
