...
import 'package:yandex_maps_mapkit/src/mapkit/images/image_url_provider.dart'
    as mapkit_images_image_url_provider;
import 'package:yandex_maps_mapkit/src/mapkit/layers/tile_format.dart'
    as mapkit_layers_tile_format;
import 'package:yandex_maps_mapkit/src/mapkit/tiles/tile_provider.dart'
    as mapkit_tiles_tile_provider;
import 'package:yandex_maps_mapkit/src/mapkit/tiles/url_provider.dart'
    as mapkit_tiles_url_provider;
import 'package:yandex_maps_mapkit/src/mapkit/zoom_range.dart'
    as mapkit_zoom_range;

part 'tile_data_source_builder.containers.dart';
part 'tile_data_source_builder.impl.dart';

abstract class BaseTileDataSourceBuilder implements ffi.Finalizable {
