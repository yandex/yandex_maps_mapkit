...
extension HighlightedRoadEventContainerExtension on HighlightedRoadEvent {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, HighlightedRoadEvent.toPointer);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
    ...
    return vector.toNativeVector(obj, HighlightedRoadEvent.toPointer);
  }
  ...
  static string_map.StringMap<HighlightedRoadEvent> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr, (val) => HighlightedRoadEvent.fromPointer(val, needFree: false));
  }
...
extension RoadEventsLayerContainerExtension on RoadEventsLayer {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, RoadEventsLayer.getNativePtr);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
    ...
    return vector.toNativeVector(obj, RoadEventsLayer.getNativePtr);
  }
  ...
  static string_map.StringMap<RoadEventsLayer> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr,
        (val) => RoadEventsLayer.fromOptionalPtr(
