...
import 'package:yandex_maps_mapkit/src/runtime/sensors/sensors.dart'
...
class MapKit implements ffi.Finalizable {
  ...
  mapkit_road_events_road_events_manager.RoadEventsManager
    ...
    return mapkit_road_events_road_events_manager.RoadEventsManager
        .fromNativePtr(_MapKit_createRoadEventsManager(ptr));
  }
  ...
  mapkit_road_events_layer_road_events_layer.RoadEventsLayer
      createRouteRoadEventsLayer(
          ...
          mapkit_road_events_layer_style_provider.RoadEventsLayerStyleProvider
              styleProvider) {
    return mapkit_road_events_layer_road_events_layer.RoadEventsLayer
        .fromNativePtr(_MapKit_createRouteRoadEventsLayer(
            ptr,
...
final ffi.Pointer<ffi.Void> Function(
    ...
    _MapKit_createTrafficLayer = lib.library
        ...
        .asFunction();
final ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)
    _MapKit_createRoadEventsManager = lib.library
        .lookup<
                ffi.NativeFunction<
                    ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>(
