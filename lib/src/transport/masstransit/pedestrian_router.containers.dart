...
extension PedestrianRouterContainerExtension on PedestrianRouter {
  static ffi.Pointer<ffi.Void> toNativeMap(
    ...
    return string_map.toNativeMap(obj, PedestrianRouter.getNativePtr);
  }
  ...
  static ffi.Pointer<ffi.Void> toNativeVector(
    ...
    return vector.toNativeVector(obj, PedestrianRouter.getNativePtr);
  }
  ...
  static string_map.StringMap<PedestrianRouter> toPlatformMap(
    ...
    return string_map.StringMap(
        ptr,
        (val) => PedestrianRouter.fromOptionalPtr(
